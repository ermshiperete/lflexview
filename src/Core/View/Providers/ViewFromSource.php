...
/**
 * Provides a View from the same folder as the source file.
 *   View template = <source>.html.php
 *   View css      = <source>.css
 */
class ViewFromSource implements IViewProvider {
	...
	function createView() {
		...
		if ($ret == NULL) {
			$filePath = str_replace('.php', '.html.php', $this->_srcFilePath);
